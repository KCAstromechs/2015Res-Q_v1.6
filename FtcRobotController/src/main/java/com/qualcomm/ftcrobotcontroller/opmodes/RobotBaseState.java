 ...
 */
public class RobotBaseState implements AstroRobotBaseInterface {
    ...
    public RobotBaseState(HardwareMap hardwareMap, LinearOpMode _callingOpMode) {
        this.initializeVariables(hardwareMap);
        callingOpMode=_callingOpMode;
    }

    public RobotBaseState(HardwareMap hardwareMap) {
        this.initializeVariables(hardwareMap);
    }
